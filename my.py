...
class table:
    ...
    def result2value(self,data,key,decode=True,encode=False,tostr=False,dttm2str=False):
    ...
    def result2values(self,data,decode=True,encode=False,tostr=False,dttm2str=False):
        values={}
